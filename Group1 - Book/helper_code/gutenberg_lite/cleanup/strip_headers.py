...
from .._domain_model.text import TEXT_END_MARKERS
from .._domain_model.text import TEXT_START_MARKERS
from .._domain_model.text import LEGALESE_END_MARKERS
from .._domain_model.text import LEGALESE_START_MARKERS
